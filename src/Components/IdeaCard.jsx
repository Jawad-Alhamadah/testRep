...
function IdeaCard(props) {
  ...
  return (
    <Link
      to={isAdmin? `/admin/idea/${props.id}` :`/Idea/${props.id}`}
      className={
        "flex flex-col border-2 my-2 p-5 rounded-lg shadow-md w-full md:w-[30vw] lg:w-[25vw] relative bg-white" + border
      }
    >
      ...
      <p className="my-4">{props.student}</p>
